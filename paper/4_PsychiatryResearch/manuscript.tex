...
\keywords{PHQ-4, depression, anxiety, brief questionnaire
validation, ultra short scale}
...
\par{ }
\par{     \begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, arc=.35mm, rightrule=.15mm, leftrule=.75mm, left=2mm, breakable, toprule=.15mm, colframe=quarto-callout-note-color-frame, colback=white, opacityback=0]
