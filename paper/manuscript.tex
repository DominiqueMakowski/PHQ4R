...
The sample consists of 500 English-speaking participants (\textbf{stats}) who were administered the revised PHQ-4 online as part of another study, which data is available in open-access at \url{https://github.com/RealityBending/IllusionGameReliability}.
...
\hypertarget{normalized-scoring}{%
\subsection{Normalized Scoring}\label{normalized-scoring}}

\hypertarget{discussion}{%
\section{Discussion}\label{discussion}}

The objective of this study was to test the introduction of a ``Once or twice'' response option to the PHQ-4 to make it more sensitive to milder fluctuations.

The fact that the new response option was the most prevalent is in itself a testimony to its usefuleness, suggesting an increased potential to discriminate a ``normal'' mood level from lower-end extremes (the true zero scores).
...
\caption{\label{tab:unnamed-chunk-3}Revised Patient Health Questionnaire-4 (PHQ-4R). The instructions are "Over the last 2 weeks, how often have you been bothered by the following problems?". The basic scoring is introduced to preserve the compatibility with the original version, and enables to use its norms and cut-offs. The normalized scoring takes into account the non-linear spacing between items.}
