...
Participants were randomly assigned to complete either the original or refined version of the PHQ-4, which included one additional response option ("Once or twice"), scored 0.5 to preserve the same scoring as the original version (creating more possible total scores - 0.5, 1.5, 2.5, etc.).
